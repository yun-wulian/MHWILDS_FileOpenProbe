...
OpenFileOrResourceStreamFn g_original_open_file_or_resource_stream{};
ReadFileOrResourceStreamFn g_original_read_file_or_resource_stream{};
...
std::atomic<bool> g_native_open_stream_hook_installed{false};
std::atomic<bool> g_native_read_stream_hook_installed{false};
...
std::atomic<uint64_t> g_native_open_stream_hits{0};
std::atomic<uint64_t> g_native_read_stream_hits{0};
...
void* g_open_file_or_resource_stream_target{};
void* g_read_file_or_resource_stream_target{};
